	...
	if not request.session.get('username'):
		...
		if campus_id == '605': #lista de todo o IFRS
			...
			if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
				with connection.cursor() as cursor:
					cursor.execute("SELECT d.matricula, p.nome AS discente, (c.nome || ' (' || m.nome || ')'), mi.descricao AS forma_ingresso, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM discente d INNER JOIN ensino.modalidade_ingresso mi ON mi.id_modalidade_ingresso = d.id_modalidade_ingresso INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.municipio m ON c.id_municipio = m.id_municipio INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND d.ano_ingresso = %s AND d.periodo_ingresso = %s AND mi.descricao = %s ORDER BY discente", [ano, semestre, parametro_detalhe]) 
					rows = cursor.fetchall();
				return JsonResponse(rows, safe=False)
			if query_selector == "curso_detalhes":
				with connection.cursor() as cursor:
					cursor.execute("SELECT d.matricula, p.nome AS discente, c.nome AS curso, mi.descricao AS forma_ingresso, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM discente d INNER JOIN ensino.modalidade_ingresso mi ON mi.id_modalidade_ingresso = d.id_modalidade_ingresso INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND d.ano_ingresso = %s AND d.periodo_ingresso = %s AND d.id_curso =  %s AND mi.descricao = %s ORDER BY discente", [ano, semestre, curso_id, parametro_detalhe]) 
					rows = cursor.fetchall();
				return JsonResponse(rows, safe=False)
			if query_selector == "turma_detalhes":
				with connection.cursor() as cursor:
					cursor.execute("SELECT d.matricula, p.nome AS discente, c.nome AS curso, mi.descricao AS forma_ingresso, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM discente d INNER JOIN ensino.modalidade_ingresso mi ON mi.id_modalidade_ingresso = d.id_modalidade_ingresso INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN ensino.matricula_componente mc ON mc.id_discente = d.id_discente WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND AND mc.id_turma = %s AND mi.descricao = %s ORDER BY discente", [turma_id, parametro_detalhe]) 
					rows = cursor.fetchall();
				return JsonResponse(rows, safe=False)
			...
			if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
				with connection.cursor() as cursor:
					cursor.execute("SELECT d.matricula, p.nome AS discente, c.nome AS curso, mi.descricao AS forma_ingresso, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM discente d INNER JOIN ensino.modalidade_ingresso mi ON mi.id_modalidade_ingresso = d.id_modalidade_ingresso INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND d.id_gestora_academica IN (SELECT id_unidade FROM dti_ifrs.montar_arvore_organiz(%s)) AND d.ano_ingresso = %s AND d.periodo_ingresso = %s AND mi.descricao = %s ORDER BY discente", [campus_id, ano, semestre, parametro_detalhe]) 
					rows = cursor.fetchall();
				return JsonResponse(rows, safe=False)
			if query_selector == "curso_detalhes":
				with connection.cursor() as cursor:
			...
			if query_selector == "turma_detalhes":
				with connection.cursor() as cursor:
					cursor.execute("SELECT d.matricula, p.nome AS discente, c.nome AS curso, mi.descricao AS forma_ingresso, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM discente d INNER JOIN ensino.modalidade_ingresso mi ON mi.id_modalidade_ingresso = d.id_modalidade_ingresso INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN ensino.matricula_componente mc ON mc.id_discente = d.id_discente WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_turma = %s AND mi.descricao = %s ORDER BY discente", [turma_id, parametro_detalhe]) 
					rows = cursor.fetchall();
				return JsonResponse(rows, safe=False)
...
def get_data_status_discente(request): #Gráfico 2
	if not request.session.get('username'):
		...
		if campus_id == '605': #lista de todo o IFRS
			...
			if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
				with connection.cursor() as cursor:
					sql_string = "SELECT d.matricula, p.nome AS discente, (c.nome || ' (' || m.nome || ')') AS curso, sd.descricao AS status, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM discente d INNER JOIN status_discente sd ON sd.status = d.status INNER JOIN ensino.matricula_componente mc ON mc.id_discente = d.id_discente INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.municipio m ON c.id_municipio = m.id_municipio INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa WHERE d.nivel IN ('G') AND t.ano = %s and t.periodo = %s AND sd.descricao = %s GROUP BY d.matricula, discente, curso, sd.descricao, p.email, celular ORDER BY discente"
...
def get_data_total_matriculas(request): #Gráfico 3
	if not request.session.get('username'):
		...
		if campus_id == '605': #lista de todo o IFRS
			...
			if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
				with connection.cursor() as cursor:
					sql_string = "WITH q1 AS (SELECT COUNT(mc.*) AS total_matricula_discente, mc.id_discente, d.matricula, p.nome AS discente, (c.nome || ' (' || m.nome || ')') AS curso, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.municipio m ON c.id_municipio = m.id_municipio WHERE d.nivel IN ('G') AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND t.ano = %s AND t.periodo = %s GROUP BY mc.id_discente, d.matricula, discente, curso, p.email, celular) SELECT matricula, discente, curso, total_matricula_discente AS total_disciplinas_ano, email, celular FROM q1 WHERE total_matricula_discente = %s GROUP BY matricula, discente, curso, total_disciplinas_ano, email, celular ORDER BY discente"
					parametros = [ano, semestre, parametro_detalhe]
					cursor.execute(sql_string, parametros)
					rows = cursor.fetchall();
				return JsonResponse(rows, safe=False)
			...
			if query_selector == "turma_detalhes":
				with connection.cursor() as cursor:
					sql_string = "WITH q1 AS (SELECT COUNT(mc.*) AS total_matricula_discente, mc.id_discente, d.matricula, p.nome AS discente, c.nome AS curso, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel IN ('G') AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND t.ano = %s AND t.periodo = %s AND t.id_turma = %s GROUP BY mc.id_discente, d.matricula, discente, curso, p.email, celular) SELECT matricula, discente, curso, total_matricula_discente AS total_disciplinas_ano, email, celular FROM q1 GROUP BY matricula, discente, curso, total_disciplinas_ano, email, celular ORDER BY discente"
					parametros = [ano, semestre, turma_id]
					cursor.execute(sql_string, parametros)
					rows = cursor.fetchall();
				return JsonResponse(rows, safe=False)
	...
	if not request.session.get('username'):
		...
		if campus_id == '605': #lista de todo o IFRS
			...
			if coluna_selecionada == "Alunos Formandos": #detalhes para coluna de CONCLUINTES
				if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
					with connection.cursor() as cursor:
						sql_string = "SELECT d.matricula, p.nome AS discente, (c.nome || ' (' || m.nome || ')') AS curso, d.prazo_conclusao, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.municipio m ON c.id_municipio = m.id_municipio WHERE d.nivel = 'G' AND d.status = 8 AND %s = (SELECT cast(cast(ano as varchar) || cast(periodo as varchar) as integer) as ano_periodo FROM comum.calendario_academico WHERE nivel = 'G' AND id_unidade = 605 AND vigente = 'true') GROUP BY matricula, discente, curso, d.prazo_conclusao, p.email, celular ORDER BY discente"
				...
				if query_selector == "curso_detalhes":
					with connection.cursor() as cursor:
						sql_string = "SELECT d.matricula, p.nome AS discente, c.nome AS curso, d.prazo_conclusao, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND d.status = 8 AND %s = (SELECT cast(cast(ano as varchar) || cast(periodo as varchar) as integer) as ano_periodo FROM comum.calendario_academico WHERE nivel = 'G' AND id_unidade = 605 AND vigente = 'true') AND d.id_curso = %s GROUP BY matricula, discente, curso, d.prazo_conclusao, p.email, celular ORDER BY discente"
				...
				if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
					with connection.cursor() as cursor:
						sql_string = "SELECT d.matricula, p.nome AS discente, (c.nome || ' (' || m.nome || ')') AS curso, d.prazo_conclusao, dg.ch_nao_atividade_obrig_pendente AS ch_componente_obrig_pendente, dg.ch_optativa_pendente, dg.ch_complementar_pendente, dg.ch_total_pendente, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN graduacao.discente_graduacao dg ON dg.id_discente_graduacao = d.id_discente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.municipio m ON c.id_municipio = m.id_municipio WHERE d.nivel = 'G' AND  d.prazo_conclusao = %s AND d.status NOT IN (-1, 2, 3, 5, 6, 8, 9, 10, 11, 12, 13, 14, 15, 16) GROUP BY matricula, discente, curso, d.prazo_conclusao, ch_componente_obrig_pendente, dg.ch_optativa_pendente, dg.ch_complementar_pendente, dg.ch_total_pendente, p.email, celular ORDER BY discente"
						parametros = [anoSemestre]
						cursor.execute(sql_string, parametros)
						rows = cursor.fetchall();
					return JsonResponse(rows, safe=False)
				if query_selector == "curso_detalhes":
					with connection.cursor() as cursor:
						sql_string = "SELECT d.matricula, p.nome AS discente, c.nome AS curso, d.prazo_conclusao, dg.ch_nao_atividade_obrig_pendente AS ch_componente_obrig_pendente, dg.ch_optativa_pendente, dg.ch_complementar_pendente, dg.ch_total_pendente, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN graduacao.discente_graduacao dg ON dg.id_discente_graduacao = d.id_discente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND  d.prazo_conclusao = %s AND d.status NOT IN (-1, 2, 3, 5, 6, 8, 9, 10, 11, 12, 13, 14, 15, 16) AND d.id_curso = %s GROUP BY matricula, discente, curso, d.prazo_conclusao, ch_componente_obrig_pendente, dg.ch_optativa_pendente, dg.ch_complementar_pendente, dg.ch_total_pendente, p.email, celular ORDER BY discente"
						parametros = [anoSemestre, curso_id]
						cursor.execute(sql_string, parametros)
						rows = cursor.fetchall();
					return JsonResponse(rows, safe=False)
				if query_selector == "turma_detalhes":
					with connection.cursor() as cursor:
						sql_string = "SELECT d.matricula, p.nome AS discente, c.nome AS curso, d.prazo_conclusao, dg.ch_nao_atividade_obrig_pendente AS ch_componente_obrig_pendente, dg.ch_optativa_pendente, dg.ch_complementar_pendente, dg.ch_total_pendente, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN graduacao.discente_graduacao dg ON dg.id_discente_graduacao = d.id_discente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND  d.prazo_conclusao = %s AND d.status NOT IN (-1, 2, 3, 5, 6, 8, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_turma = %s GROUP BY matricula, discente, curso, d.prazo_conclusao, ch_componente_obrig_pendente, dg.ch_optativa_pendente, dg.ch_complementar_pendente, dg.ch_total_pendente, p.email, celular ORDER BY discente"
						parametros = [anoSemestre, turma_id]
						cursor.execute(sql_string, parametros)
						rows = cursor.fetchall();
					return JsonResponse(rows, safe=False) 
				...
				if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
					with connection.cursor() as cursor:
						sql_string = "SELECT d.matricula, p.nome AS discente, (c.nome || ' (' || m.nome || ')') AS curso, d.prazo_conclusao, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.municipio m ON c.id_municipio = m.id_municipio WHERE d.nivel = 'G' AND  d.prazo_conclusao < %s AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) GROUP BY matricula, discente, curso, d.prazo_conclusao, p.email, celular ORDER BY discente"
						parametros = [anoSemestre]
						cursor.execute(sql_string, parametros)
						rows = cursor.fetchall();
					return JsonResponse(rows, safe=False)
				if query_selector == "curso_detalhes":
					with connection.cursor() as cursor:
						sql_string = "SELECT d.matricula, p.nome AS discente, c.nome AS curso, d.prazo_conclusao, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND  d.prazo_conclusao < %s AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND d.id_curso = %s GROUP BY matricula, discente, curso, d.prazo_conclusao, p.email, celular ORDER BY discente"
						parametros = [anoSemestre, curso_id]
						cursor.execute(sql_string, parametros)
						rows = cursor.fetchall();
					return JsonResponse(rows, safe=False)
				if query_selector == "turma_detalhes":
					with connection.cursor() as cursor:
						sql_string = "SELECT d.matricula, p.nome AS discente, c.nome AS curso, d.prazo_conclusao, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND  d.prazo_conclusao < %s AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_turma = %s GROUP BY matricula, discente, curso, d.prazo_conclusao, p.email, celular ORDER BY discente"
						parametros = [anoSemestre, turma_id]
						cursor.execute(sql_string, parametros)
						rows = cursor.fetchall();
					return JsonResponse(rows, safe=False) 
			...
			if coluna_selecionada == "Alunos Formandos": #detalhes para coluna de CONCLUINTES
				...
				if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
					with connection.cursor() as cursor:
						sql_string = "SELECT d.matricula, p.nome AS discente, c.nome AS curso, d.prazo_conclusao, dg.ch_nao_atividade_obrig_pendente AS ch_componente_obrig_pendente, dg.ch_optativa_pendente, dg.ch_complementar_pendente, dg.ch_total_pendente, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN graduacao.discente_graduacao dg ON dg.id_discente_graduacao = d.id_discente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND  d.prazo_conclusao = %s AND d.status NOT IN (-1, 2, 3, 5, 6, 8, 9, 10, 11, 12, 13, 14, 15, 16) AND d.id_gestora_academica IN (SELECT id_unidade FROM dti_ifrs.montar_arvore_organiz(%s)) GROUP BY matricula, discente, curso, d.prazo_conclusao, ch_componente_obrig_pendente, dg.ch_optativa_pendente, dg.ch_complementar_pendente, dg.ch_total_pendente, p.email, celular ORDER BY discente"
						parametros = [anoSemestre, campus_id]
						cursor.execute(sql_string, parametros)
						rows = cursor.fetchall();
					return JsonResponse(rows, safe=False)
				...
				if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
					with connection.cursor() as cursor:
						sql_string = "SELECT d.matricula, p.nome AS discente, c.nome AS curso, d.prazo_conclusao, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND  d.prazo_conclusao < %s AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND d.id_gestora_academica IN (SELECT id_unidade FROM dti_ifrs.montar_arvore_organiz(%s)) GROUP BY matricula, discente, curso, d.prazo_conclusao, p.email, celular ORDER BY discente"
						parametros = [anoSemestre, campus_id]
						cursor.execute(sql_string, parametros)
						rows = cursor.fetchall();
					return JsonResponse(rows, safe=False)
	...
	if not request.session.get('username'):
		...
		if campus_id == '605': #lista de todo o IFRS
			...
			if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
				with connection.cursor() as cursor:
					...
					if parametro_detalhe == "DISCENTES EM EXAME":
						sql_string="WITH Q1 AS(SELECT d.matricula, p.nome AS discente, (c.nome || ' (' || m.nome || ')') AS curso, ccd.nome AS disciplina, SUM(nu.nota_final_unidade) / 2 AS media_parcial, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.nota_unidade nu ON nu.id_matricula_componente = mc.id_matricula_componente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.municipio m ON c.id_municipio = m.id_municipio INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes WHERE nu.nota_final_unidade IS NOT NULL AND d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND t.ano = %s AND t.periodo = %s GROUP BY d.matricula, discente, curso, disciplina, p.email, celular) SELECT matricula, discente, curso, disciplina, ROUND (CAST(media_parcial AS numeric),2) AS media_final, email, celular FROM q1 WHERE q1.media_parcial < 7 GROUP BY matricula, discente, curso, disciplina, media_parcial, email, celular ORDER BY discente, media_parcial"
			...
			if query_selector == "curso_detalhes":
				with connection.cursor() as cursor:
					if parametro_detalhe == "DISCENTES EM EXAME":
						sql_string="WITH Q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, SUM(nu.nota_final_unidade) / 2 AS media_parcial, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.nota_unidade nu ON nu.id_matricula_componente = mc.id_matricula_componente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes WHERE nu.nota_final_unidade IS NOT NULL AND d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND t.ano = %s AND t.periodo = %s AND d.id_curso = %s GROUP BY d.matricula, discente, curso, disciplina, p.email, celular) SELECT matricula, discente, curso, disciplina, ROUND (CAST(media_parcial AS numeric),2) AS media_final, email, celular FROM q1 WHERE q1.media_parcial < 7 GROUP BY matricula, discente, curso, disciplina, media_parcial, email, celular ORDER BY discente, media_parcial"
					elif parametro_detalhe == "DISCENTES QUE NÃO ESTÃO EM EXAME":
						sql_string="WITH Q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, SUM(nu.nota_final_unidade) / 2 AS media_parcial, p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.nota_unidade nu ON nu.id_matricula_componente = mc.id_matricula_componente INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes WHERE nu.nota_final_unidade IS NOT NULL AND d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND t.ano = %s AND t.periodo = %s AND d.id_curso = %s GROUP BY d.matricula, discente, curso, disciplina, p.email, celular) SELECT matricula, discente, curso, disciplina, ROUND (CAST(media_parcial AS numeric),2) AS media_final, email, celular FROM q1 WHERE q1.media_parcial >= 7 GROUP BY matricula, discente, curso, disciplina, media_parcial, email, celular ORDER BY discente, media_parcial"
					parametros = [ano, semestre, curso_id]
					cursor.execute(sql_string, parametros)
	...
	if not request.session.get('username'):
		...
		if campus_id == '605': #lista de todo o IFRS
			...
			if parametro_detalhe == "100":
				...
				if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, (c.nome || ' (' || m.nome || ')') AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.municipio m ON c.id_municipio = m.id_municipio WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano= %s AND mc.periodo = %s) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia = %s ORDER BY discente, frequencia"
					parametros = [ano, semestre, parametro_detalhe]
				elif query_selector == "curso_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano = %s AND mc.periodo = %s AND d.id_curso =  %s) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia = %s ORDER BY discente, frequencia"
					parametros = [ano, semestre, curso_id, parametro_detalhe]
				elif query_selector == "turma_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano = %s AND mc.periodo = %s AND mc.id_turma = %s) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia = %s ORDER BY discente, frequencia"
					parametros = [ano, semestre, turma_id, parametro_detalhe]
				...
				if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, (c.nome || ' (' || m.nome || ')') AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.municipio m ON c.id_municipio = m.id_municipio WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano= %s AND mc.periodo = %s) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia IS NULL ORDER BY discente, frequencia"
					parametros = [ano, semestre]  
				elif query_selector == "curso_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano = %s AND mc.periodo = %s AND d.id_curso =  %s) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia IS NULL ORDER BY discente, frequencia"
					parametros = [ano, semestre, curso_id]
				elif query_selector == "turma_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano = %s AND mc.periodo = %s AND mc.id_turma = %s) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia IS NULL ORDER BY discente, frequencia"
					parametros = [ano, semestre, turma_id]
			else:
				...
				if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, (c.nome || ' (' || m.nome || ')') AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso INNER JOIN comum.municipio m ON c.id_municipio = m.id_municipio WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano= %s AND mc.periodo = %s) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia < %s AND frequencia >= %s ORDER BY discente, frequencia"
					parametros = [ano, semestre, frequencia_maxima, frequencia_minima]
				elif query_selector == "curso_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano = %s AND mc.periodo = %s AND d.id_curso =  %s) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia < %s AND frequencia >= %s ORDER BY discente, frequencia"
					parametros = [ano, semestre, curso_id, frequencia_maxima, frequencia_minima]
				elif query_selector == "turma_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano = %s AND mc.periodo = %s AND mc.id_turma = %s) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia < %s AND frequencia >= %s ORDER BY discente, frequencia"
			...
			if parametro_detalhe == "100":
				...
				#consulta pra sem frequencia
				if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano= %s AND mc.periodo = %s AND d.id_gestora_academica IN (SELECT id_unidade FROM dti_ifrs.montar_arvore_organiz(%s))) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia IS NULL ORDER BY discente, frequencia"
					parametros = [ano, semestre, campus_id]  
				elif query_selector == "curso_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano= %s AND mc.periodo = %s AND d.id_gestora_academica IN (SELECT id_unidade FROM dti_ifrs.montar_arvore_organiz(%s)) AND d.id_curso =  %s) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia IS NULL ORDER BY discente, frequencia"
					parametros = [ano, semestre, campus_id, curso_id]
				elif query_selector == "turma_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano= %s AND mc.periodo = %s AND mc.id_turma = %s) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia IS NULL ORDER BY discente, frequencia"
					parametros = [ano, semestre, turma_id]
				...
				if query_selector == "campus_detalhes" or query_selector == "periodo_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano= %s AND mc.periodo = %s AND d.id_gestora_academica IN (SELECT id_unidade FROM dti_ifrs.montar_arvore_organiz(%s))) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia < %s AND frequencia >= %s ORDER BY discente, frequencia"
					parametros = [ano, semestre, campus_id, frequencia_maxima, frequencia_minima]
				elif query_selector == "curso_detalhes":
					sql_string = "WITH q1 AS(SELECT d.matricula, p.nome AS discente, c.nome AS curso, ccd.nome AS disciplina, mc.porcentagem_frequencia AS frequencia,  p.email, translate(('55' || CAST(p.codigo_area_nacional_telefone_celular AS varchar) || p.telefone_celular), '-', '') AS celular FROM ensino.matricula_componente mc INNER JOIN ensino.turma t ON t.id_turma = mc.id_turma INNER JOIN discente d ON d.id_discente = mc.id_discente INNER JOIN ensino.componente_curricular_detalhes ccd ON ccd.id_componente_detalhes = mc.id_componente_detalhes INNER JOIN comum.pessoa p ON p.id_pessoa = d.id_pessoa INNER JOIN curso c ON c.id_curso = d.id_curso WHERE d.nivel = 'G' AND d.status NOT IN (-1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16) AND mc.id_situacao_matricula IN (2, 6, 7 , 9, 25, 26, 27, 4, 21, 22, 24) AND mc.ano= %s AND mc.periodo = %s AND d.id_gestora_academica IN (SELECT id_unidade FROM dti_ifrs.montar_arvore_organiz(%s)) AND d.id_curso =  %s) SELECT matricula, discente, curso, disciplina, frequencia, email, celular FROM q1 WHERE frequencia < %s AND frequencia >= %s ORDER BY discente, frequencia"
